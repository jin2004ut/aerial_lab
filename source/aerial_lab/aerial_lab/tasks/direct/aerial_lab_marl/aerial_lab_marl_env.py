...
from .aerial_lab_marl_env_cfg import AerialLabMarlEnvCfg


class AerialLabMarlEnv(DirectMARLEnv):
    cfg: AerialLabMarlEnvCfg

    def __init__(self, cfg: AerialLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
