...
gym.register(
    id="Aerial-Velocity-Flat-Unitree-Go1-v0",
...
# gym.register(
#     id="Aerial-Velocity-Flat-Unitree-Go1-Play-v0",
#     entry_point="isaaclab.envs:ManagerBasedRLEnv",
#     disable_env_checker=True,
#     kwargs={
...
gym.register(
    id="Aerial-Velocity-Rough-Unitree-Go1-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# gym.register(
#     id="Aerial-Velocity-Rough-Unitree-Go1-Play-v0",
#     entry_point="isaaclab.envs:ManagerBasedRLEnv",
#     disable_env_checker=True,
#     kwargs={
