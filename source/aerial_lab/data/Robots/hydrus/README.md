...
**Definition**: Transformable multirotor with two-dimensional multilinks
...
**note**: the following instructions are based on hex type robot, we also have quad type robot (change the var ```type```)
